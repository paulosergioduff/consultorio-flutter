...
import 'package:sub_locacoes/engine/yellow-widgets.dart';
...
final rotareserva = "$colletionDomain/salas/data";

class YellowCrud extends StatefulWidget {
  @override
  _YellowCrudState createState() => _YellowCrudState();
}

class _YellowCrudState extends State<YellowCrud> {
  // ====================================================== //
