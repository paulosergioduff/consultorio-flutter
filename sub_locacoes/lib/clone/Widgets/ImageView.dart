...
import 'package:sub_locacoes/clone/Routes/Payer.dart';
import 'package:sub_locacoes/clone/Routes/Property-details.dart';
    ...
    return Container(
        ...
        child: GestureDetector(
          child: Container(
            ...
            child: Icon(
              !widget._liked ? Icons.favorite_border : Icons.favorite,
              color: !widget._liked ? Colors.black : Constants.redAirbnb,
              size: 25,
            ),
          ),
          onTap: () {
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => PropertyDetails(widget.property)),
          );
        },
        child: Column(
          children: <Widget>[
            Container(
              ...
              child: Stack(
                children: <Widget>[
                  buildImageSlider(context, PageController(),
                      widget._currentIndex, widget.property),
                  buildWidgetImageIndicator(
                      context, Constants.properties[1], widget._currentIndex),
                  ...
                  Column(
                    children: [
                      ...
                      Align(
                        alignment: Alignment.topLeft,
                        child: Text(
                          widget.property.address.wilaya,
                          style: TextStyle(
                              color: Colors.black87,
                              fontSize: 18,
                              fontWeight: FontWeight.w400),
